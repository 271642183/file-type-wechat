...
const fileType = path => {
  ...
  /**
   * 十进制 255, 216, 255 控制台查看 buffer数组里是十进制
   * 十六进制 0xFF, 0xD8, 0xFF
   * ASCII ÿØÿ 
   * ps: jpg和个别文件格式ASCII文本比较奇葩
   */
   ...
   * 十六进制 0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A
   * ASCIIPNG
   */
